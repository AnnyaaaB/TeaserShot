...
const NavBar = ({ handleModalState, handleContactTab, theme, setTheme }) => {
  ...
  return (
    <div className="nav-bar">
      <div className="nav-menu">
        ...
        <button onClick={handleContactTab} style={{fontSize: "16px", background: "none", border: "none", fontWeight:"600"}}>Contact Us</button>
      ...
      <div className="nav-hamburger">
        ...
        <div className={dropdown ? "dropdown clicked" : "dropdown"}>
          ...
          <li><button onClick={handleContactTab} style={{fontSize: "16px", background: "none", border: "none", fontWeight:"600"}}>Contact Us</button></li>
